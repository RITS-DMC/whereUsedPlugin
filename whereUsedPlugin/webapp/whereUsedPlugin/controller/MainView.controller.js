sap.ui.define([
    ...
    return PluginViewController.extend("huka.custom.plugin.whereUsedPlugin.whereUsedPlugin.controller.MainView", {
        onInit: function () {
            ...
            console.log("Model Data of the MDO: ",mdoModel);
            var that = this;
        ...
        */
        _retrieveWhereComponentUsed(swhereUsedPPDKey, sComponents) {
            console.log("s components for the PPD: ",sComponents);
            console.log("s where used PPD key:  ",swhereUsedPPDKey);
            var that = this;
            return new Promise(function (resolve, reject) {      
                if (sComponents != null) {
                    ...
                    that.ajaxPostRequest(url, payload,
                        function (aResponds) { 
                            console.log("Response from the PPD: ",aResponds); // anonym function we are calling, as we need to save the parent context we store this into that before
